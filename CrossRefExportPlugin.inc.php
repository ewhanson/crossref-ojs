...
class CrossRefExportPlugin extends DOIPubIdExportPlugin
{
                ...
                new LinkAction(
                    ...
                    new AjaxModal(
                        $dispatcher->url(
                            ...
                            'manage',
                            null,
                            array('plugin' => 'CrossRefExportPlugin', 'category' => 'importexport', 'verb' => 'statusMessage',
    ...
    public function exportAndDeposit($request, $objects, $filter, $tab, $objectsFileNamePart, $noValidation = null, $shouldRedirect = true)
    {
        $context = $request->getContext();
