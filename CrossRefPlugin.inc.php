...
class CrossRefPlugin extends GenericPlugin implements IDoiRegistrationAgency
{
    ...
    public function exportSubmissions(array $submissions, Context $context) : array
    {
       ...
       $tempFileId =  $exportPlugin->exportAsDownload($context, $submissions, $filterName, 'articles', null, $xmlErrors);
    ...
    public function depositSubmissions(array $submissions, Context $context): array
    {
        ...
        $filterName = $exportPlugin->getSubmissionFilter();
        $responseMessage = '';
        $status = $exportPlugin->exportAndDeposit($context, $submissions, $filterName, 'article', $responseMessage);
    ...
    {
        // TODO: #doi See exportSubmission() for question relevant here
        ...
        $tempFileId = $exportPlugin->exportAsDownload($context, $issues, $filterName, 'articles', null, $xmlErrors);
        return ['tempFileId' => $tempFileId, 'xmlErrors' => $xmlErrors];
    }
    ...
    public function depositIssues(array $issues, Context $context): array
    {
        ...
        $filterName = $exportPlugin->getIssueFilter();
        $responseMessage = '';
        $status = $exportPlugin->exportAndDeposit($context, $issues, $filterName, 'issue', $responseMessage);
